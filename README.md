...
- **Employer matching** — the employer contribution can be _Fixed_ (paid unconditionally) or _Matched_ (the employer pays the lesser of its rate and yours, so contributing nothing forfeits the match). Common in UK workplace schemes
