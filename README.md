...
- **Tax-optimal contribution** — switch the employee contribution to _Auto_ and the app solves for the salary-sacrifice rate that strips out every pound taxed above the basic rate (escaping the 45% additional rate, the 60% personal-allowance trap at £100k–£125,140, and the 40% higher-rate band), capped by the £60,000 annual allowance (tapered for high earners) and never sacrificing below the tax-free personal allowance. With matching on, it also contributes at least up to the match cap to capture all the free employer money — and correctly settles for less high-rate tax escape when doubling up on a match would otherwise breach the allowance
